...
define("LM_FRONT_CHOOSE_PACKAGE_SUB","<small>Si us plau, selecciona la teva versió de Wordpress per instal·lar</small>");
define("LM_FRONT_TOP","<span colspan='2' class='contentheading'>Instal·lar programari Wordpress vía web</span>");
define("LM_FRONT_TOP_FTP_DETAILS","<h2>Introdueix les teves dades ftp: </h2>");
define("LM_FRONT_WEBSITE_URL","<b>Url de la web: </b>");
define("LM_FRONT_WEBSITE_URL_SUB","<small>Si us plau, introdueix la url de la web on s'instal·larà Wordpress. Exemple: http://www.sitename.com/wordpress</small>");
...
define("LM_FRONT_FTP_DIR_SUB","<small>Si us plau, introduiu el directori FTP on us agradaria instal·lar Wordpress. Exemple: public_html/Wordpress o htdocs/Wordpress i assegureu-vos de que té permisos per tothom, generalment 777</small>");
...
define("LM_CONFIG_SYSTEM_LANG_SUB","<small>Configura l'idoma de XCloner. si es deix en -default- mostrarà el que vé per defecte en Wordpress.</small>");
...
define("LM_MSG_BACK_10","La ruta del Wordpress no està dins de la ruta de la còpia de seguretat! No podrà usar el mode de descàrrega directa! Hauría d'editar la seva Configuració -> Sistema i establir l' -Enllaç de descàrrega directa- a -No-");
define("LM_MSG_BACK_11","Procés de còpia de seguretat manual completat!<a href='plugins.php?page=xcloner_show&option=com_cloner&task=view'>Prem aquí per continuar</a>");
...
define("LM_CRON_SUB","<b>Usant la funció Cron pots configurar un generador automàtic de còpies de seguretat per la teva web Wordpress:</b><br>
...
define("LM_TRANSFER_FTP_DIR_SUB","Si us plau, introduiu el directori FTP on us agradaria instal·lar Wordpress. Exemple: public_html/Wordpress o htdocs/Wordpress i assegureu-vos de que té permisos per tothom, generalment 777.");
...
<pre>
Restaurar les teves còpies de seguretat mai havia sigut tan fàcil. Amb l'ajuda de la funció de clonat de <a href='plugins.php?page=xcloner_show&?option=com_cloner&task=view'>Veure còpies</a>
...
<b>Atenció:</b>Si aquest procés falla per alguna raó. Feu el següent: 
   ...
   <b>XCloner.php - L'script de restauració -</b>
        - En aquest pas ja tens en posició el clon que has fet basat en el teu lloc Wordpress i l'script de restauració.
...
define("LM_CLONER_ABOUT","<h2>Còpia de seguretat XCloner</h2><br />
      <pre>XCloner és una eina que t'ajudarà a manegar les teves còpies de seguretat dels teus llocs Wordpress, generar/restaurar/moure, de forma que el teu lloc sempre estigui segur. <b>Característiques:</b>
