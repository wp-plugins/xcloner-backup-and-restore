...
define("LM_MSG_BACK_11","All done! Manual Backup process finished! <a href='plugins.php?page=xcloner_show&option=com_cloner&task=view'>Click here to continue</a>");
...
<pre>
   ...
   With the help of our cloning function from the <a href='plugins.php?page=xcloner_show&option=com_cloner&task=view'>View Backups</a> screen
